...
import { cowGif, construction, flyingEnvelope, catOnPiano, butterfly, thumbsUp,
...
export default function AssetSources(){
    ...
    <div className="mainContent">
        ...
        <div className="contentBoxCenter">
            <p className="sourceLink">
                <a href="https://web.archive.org/web/20090902203215/http://geocities.com/voortcow/Victims.html"
                    ...
                    <img className="gifAsset" src={cowGif} alt="black and white cow turning its head" />
                </a>
                <a href="https://web.archive.org/web/20091027035606/http://es.geocities.com/melgarbeatles6/prolpg.html"
                    target="_blank" rel="noreferrer">
                    <img className="gifAsset" src={construction}
        ...
        <div className="contentBoxCenter">
            <a href="https://cyber.dabamos.de/88x31/" target="_blank" rel="noreferrer" className="sourceLink">
                <img src={css} alt="88x31 made with cascading style sheets" />
            </a>
            <a href="https://cyber.dabamos.de/88x31/" target="_blank" rel="noreferrer" className="sourceLink">
                <img src={adobe} alt="88x31 get Adobe Flash Player" />
            </a>
            <a href="https://cyber.dabamos.de/88x31/index2.html" target="_blank" rel="noreferrer" className="sourceLink">
            ...
            target="_blank" rel="noreferrer" className="sourceLink">
                <img src={spongebobWebsite} alt="88x31 The Spongebob Website" />
            </a>
        </div>
        <div className=" contentBoxCenter">
            <h3>Other Assets</h3>
            <a href="https://schumacher.com/catalog/products/177381" target="_blank" rel="noreferrer" className="sourceLink">
...
/*
No known source for Pink Panther gif
